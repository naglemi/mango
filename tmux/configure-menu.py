...
MENU_ITEMS = [
    ...
    ("❌ Close Pane", "z", "display-menu -T 'Close Pane?' 'Yes (Kill)' z 'kill-pane' 'Break to Window' p 'break-pane' 'Suspend' q 'send-keys C-z' 'No (Cancel)' r ''", True, True, "core", "Displays menu with options: kill pane, break to window, suspend process (Ctrl+Z), or cancel."),
